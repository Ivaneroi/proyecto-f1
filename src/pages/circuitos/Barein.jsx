...
export default function Barein() {
  ...
  // Información del GP (hardcoded para Japón)
  const gpInfo = {
  ...
  return (
    <div className="barein-page bg-black text-white min-h-screen">
      <Menu />
          ...
          <>
            ...
            <div className="clasification-cont border-l border-r border-gray-400 mt-10 max-w-6xl mx-auto">
              <div className="cont-clasification-pilots p-4">
                <h2 className="f1-bold text-white text-4xl mb-2 text-center">
                  CLASIFICACIÓN
                </h2>
                  ...
                  {datosCarrera.resultados.map((p) => (
                    <React.Fragment key={p.numeroPiloto}>
                      ...
                      <div className="photo-and-name-pilot flex pl-24">
                        ...
                        <p className="p-4 f1-light text-white text-2xl">
                          {p.nombreCompleto}
                        </p>
                      </div>
            ...
            <div className="mt-8 text-center text-gray-500 f1-light">
              ...
              <p className="text-sm">Gran Premio de Australia 2025</p>
            </div>
          </>
        ) : (
          <div className="text-center py-20">
