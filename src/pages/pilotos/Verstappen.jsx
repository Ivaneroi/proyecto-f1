...
export default function Verstappen() {
  const slug = "verstappen"; // Solo cambiar esto en cada archivo
  ...
  return (
    <div className="cont-verstappen bg-black text-white scroll-smooth">
      <Menu />
