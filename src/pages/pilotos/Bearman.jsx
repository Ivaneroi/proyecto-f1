...
export default function Bearman() {
  const slug = "bearman"; // Solo cambiar esto en cada archivo
  ...
  return (
    <div className="cont-bearman bg-black text-white scroll-smooth">
      <Menu />
      ...
      <div className="flex flex-col xl:flex-row max-w-[100vw] overflow-x-hidden">
        ...
        <div className="w-full xl:w-3/4 p-4 sm:p-6 md:p-8 text-left">
          <header className="pb-10 text-center">
            <h1
              className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl f1-title text-[#E10600]">
